...
CREATE TABLE Member(
        ...
        CONSTRAINT Member_Location_FK FOREIGN KEY (id_location) REFERENCES Location(id_location) ,
        CONSTRAINT Member_Statut_FK FOREIGN KEY (id_statut) REFERENCES Statut(id_statut)
)ENGINE=InnoDB;
...
CREATE TABLE Image(
        ...
        img_likes             Int NOT NULL DEFAULT 0 ,
        img_approbate_date    Date DEFAULT NULL,
        id_member             Int NOT NULL ,
        id_member_approbator  Int DEFAULT NULL,
        CONSTRAINT Image_PK PRIMARY KEY (id_img) ,

        CONSTRAINT Image_Member_FK FOREIGN KEY (id_member) REFERENCES CAASis_NATIONAL_DB.Member(id_member) ,
        CONSTRAINT Image_Member_Approbator_FK FOREIGN KEY (id_member_approbator) REFERENCES CAASis_NATIONAL_DB.Member(id_member)
)ENGINE=InnoDB;
...
CREATE TABLE Comment(
        ...
        CONSTRAINT Comment_Member_FK FOREIGN KEY (id_member) REFERENCES CAASis_NATIONAL_DB.Member(id_member) ,
        CONSTRAINT Comment_Image_FK FOREIGN KEY (id_img) REFERENCES Image(id_img),
        CONSTRAINT Comment_Member_Approbator_FK FOREIGN KEY (id_member_approbator) REFERENCES CAASis_NATIONAL_DB.Member(id_member)
)ENGINE=InnoDB;
...
CREATE TABLE Like_Img(
        ...
        CONSTRAINT Like_Img_Image_FK FOREIGN KEY (id_img) REFERENCES Image(id_img) ,
        CONSTRAINT Like_Img_Member_FK FOREIGN KEY (id_member) REFERENCES CAASis_NATIONAL_DB.Member(id_member)
)ENGINE=InnoDB;
...
CREATE TABLE Manifestation(
        ...
        manifestation_votes          Int NOT NULL DEFAULT 0 ,
        ...
        CONSTRAINT Manifestation_Member_Suggest_FK FOREIGN KEY (id_member_suggest) REFERENCES CAASis_NATIONAL_DB.Member(id_member) ,
        CONSTRAINT Manifestation_Member_Plan_FK FOREIGN KEY (id_member_plan) REFERENCES CAASis_NATIONAL_DB.Member(id_member) ,
        CONSTRAINT Manifestation_Member_Approbator_FK FOREIGN KEY (id_member_approbator) REFERENCES CAASis_NATIONAL_DB.Member(id_member)
)ENGINE=InnoDB;
...
CREATE TABLE Vote(
        ...
        CONSTRAINT Vote_Manifestation_FK FOREIGN KEY (id_manifestation) REFERENCES Manifestation(id_manifestation) ,
        CONSTRAINT Vote_Member_FK FOREIGN KEY (id_member) REFERENCES CAASis_NATIONAL_DB.Member(id_member)
)ENGINE=InnoDB;
...
CREATE TABLE Illustrate_Manifestation(
        ...
        CONSTRAINT Illustrate_Manifestation_Image_FK FOREIGN KEY (id_img) REFERENCES Image(id_img) ,
        CONSTRAINT Illustrate_Manifestation_Manifestation_FK FOREIGN KEY (id_manifestation) REFERENCES Manifestation(id_manifestation)
)ENGINE=InnoDB;
...
CREATE TABLE Participate(
        ...
        CONSTRAINT Participate_Manifestation_FK FOREIGN KEY (id_manifestation) REFERENCES Manifestation(id_manifestation) ,
        CONSTRAINT Participate_Member_FK FOREIGN KEY (id_member) REFERENCES CAASis_NATIONAL_DB.Member(id_member)
)ENGINE=InnoDB;
...
CREATE TABLE Article(
        ...
        CONSTRAINT Article_Image_FK FOREIGN KEY (id_img) REFERENCES Image(id_img) ,
        CONSTRAINT Article_Category_FK FOREIGN KEY (id_category) REFERENCES Category(id_category)
)ENGINE=InnoDB;
...
CREATE TABLE Purchase(
        ...
        CONSTRAINT Purchase_Member_FK FOREIGN KEY (id_member) REFERENCES CAASis_NATIONAL_DB.Member(id_member)
)ENGINE=InnoDB;
...
CREATE TABLE Command(
        ...
        CONSTRAINT Command_Article_FK FOREIGN KEY (id_article) REFERENCES Article(id_article) ,
        CONSTRAINT Command_Purchase_FK FOREIGN KEY (id_purchase) REFERENCES Purchase(id_purchase)
)ENGINE=InnoDB;
...
CREATE TABLE Shopping_Cart(
        ...
        ,CONSTRAINT Shopping_Cart_Article_FK FOREIGN KEY (id_article) REFERENCES Article(id_article)
        ,CONSTRAINT Shopping_Cart_Member_FK FOREIGN KEY (id_member) REFERENCES CAASis_NATIONAL_DB.Member(id_member)
)ENGINE=InnoDB;
